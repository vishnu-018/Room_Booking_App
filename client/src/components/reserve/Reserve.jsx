    ...
    <div className="reserve">
      <div className="rContainer">
        ...
        <div className="rSummary">
          ...
          <p><b>Check-in:</b> {new Date(dates[0].startDate).toDateString()}</p>
          <p><b>Check-out:</b> {new Date(dates[0].endDate).toDateString()}</p>
          <p><b>Number of nights:</b> {getDatesInRange(dates[0].startDate, dates[0].endDate).length}</p>
